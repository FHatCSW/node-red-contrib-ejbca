...
module.exports = function (RED) {
    ...
    function ExportKeysNode(config) {
        ...
        this.on("input", function (msg) {
            ...
            const privatefileName = resolveValue(msg, this.fieldTypePrivateFileName, globalContext, flowContext, this.privatefileName, false);
            const publicfileName = resolveValue(msg, this.fieldTypePublicFileName, globalContext, flowContext, this.publicfileName, false);
            ...
            const privateKeyPath = path.join(outputDirectory, privatefileName + ".key");
            const publicKeyPath = path.join(outputDirectory, publicfileName + ".key");
