...
module.exports = function (RED) {
    function GetRevocationStatus(config) {
        ...
        node.on('input', function (msg, send, done) {
            ...
            const serialNnumber = resolveValue(msg, this.fieldTypeSerialNumber, globalContext, flowContext, this.serialNumber);

            const api = "/ejbca/ejbca-rest-api/v1/certificate/CN%3D" + issuer_dn + "/" + serialNnumber + "/revocationstatus";
