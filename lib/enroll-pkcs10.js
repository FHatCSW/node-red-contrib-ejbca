...
module.exports = function (RED) {
    function EnrollPkcs10(config) {
        ...
        node.on('input', function (msg, send, done) {
                ...
                const username = resolveValue(msg, this.fieldTypeusername, globalContext, flowContext, this.username, false);
                const certificate_request = resolveValue(msg, this.fieldTypecsrInfo, globalContext, flowContext, this.csrInfo, false);
